...
//Api/certificacion
//Crear certificacion
router.post('/', certificacionControllers.crearCertificacion);
...
router.put('/:idcertificacion', certificacionControllers.putCertificacion);
//Eliminar Certificacion por id de Certificacion
router.delete('/:idcertificacion', certificacionControllers.deleteCertificacion);
